...
export function LearningHeader({ onChoose, disabled = false, view, onViewChange, mode, progress, onPracticeChoice, onRestart, onClear, ready }: {
  onChoose: (prompt: string, label: string) => void; disabled?: boolean; view: LearningView; onViewChange: (view: LearningView) => void;
  mode: Mode; progress: Practice; onPracticeChoice: (index: number) => void; onRestart: () => void; onClear: () => void; ready: boolean;
}) {
