...
from modurouter.models import Base, QuotaBucket, RuntimeLock, SpeechRequest, User
...
async def test_transcription_billing_and_request(outcome, monkeypatch):
    ...
    async with engine.begin() as connection:
        await connection.run_sync(lambda sync: Base.metadata.create_all(sync, tables=[User.__table__, RuntimeLock.__table__, QuotaBucket.__table__, SpeechRequest.__table__]))
